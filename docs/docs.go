...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/areas_estudo/search": {
            "get": {
                "description": "Busca áreas de estudo com texto, filtros e paginação",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Texto de busca (nome da área)",
                        "name": "search",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filtro (campo genérico ou avançado)",
                        "name": "filter",
                        "in": "query"
                    },
                    {
        ...
        "/departments/search": {
            "get": {
                "description": "Busca departamentos com filtros e paginação",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Texto de busca (nome do departamento)",
                        "name": "search",
                        "in": "query"
                    },
                    {
        ...
        "/departments/{id}": {
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Erro de validação padronizado (UUID inválido, departamento não encontrado, etc.)",
                        "schema": {
                            "$ref": "#/definitions/utils.Payload"
                        }
                    },
            ...
            "put": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Erro de validação padronizado",
                        "schema": {
                            "$ref": "#/definitions/utils.Payload"
                        }
                    }
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Erro de validação padronizado (UUID inválido, departamento não encontrada, etc.)",
                        "schema": {
                            "$ref": "#/definitions/utils.Payload"
                        }
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.CreateDependentDTO"
                        }
                    }
                ],
                "responses": {
        ...
        "/districts/search": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Texto de busca (nome do distrito)",
                        "name": "search",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dtos.DistritoResultDTO"
                            }
                        }
                    },
                    "500": {
        ...
        "/documents": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "UUID do proprietário (owner)",
                        "name": "owner_id",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "integer",
                        "description": "Limite de resultados (ex.: 20)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Offset para paginação (ex.: 0)",
                        "name": "offset",
                        "in": "query"
                    }
                ],
        ...
        "/documents/upload": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "ex.: employee, dependent",
                        "name": "owner_type",
                        "in": "formData",
                        "required": true
                    },
                    ...
                    {
                        "type": "string",
                        "description": "Tipo lógico do documento (BI, Contrato, etc.)",
                        "name": "type",
                        "in": "formData",
                        "required": true
                    },
        ...
        "/documents/{id}": {
            ...
            "delete": {
                ...
                "summary": "Remove um documento (S3 + BD)",
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID do documento",
        ...
        "/documents/{id}/file": {
            "put": {
                ...
                "summary": "Substitui o ficheiro do documento (upload novo, atualiza BD e apaga o antigo)",
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID do documento",
        ...
        "/education": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dtos.EducationResponseDTO"
                            }
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Dados do histórico educacional",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.CreateEducationDTO"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.UpdateEducationDTO"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dtos.EmployeeStatusResponseDTO"
                            }
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.CreateEmployeeStatusDTO"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.UpdateEmployeeStatusDTO"
                        }
                    }
                ],
                "responses": {
        ...
        "/employees": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Validação dos campos (Fields detalhados)",
                        "schema": {
                            "$ref": "#/definitions/utils.Payload"
                        }
                    },
        ...
        "/employees/search": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Texto de busca (nome, email, nº funcionário, etc.)",
                        "name": "search",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filtro avançado (ex.: dept:UUID, pos:UUID, ativo:true)",
                        "name": "filter",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.CreateMunicipioDoc"
                        }
                    }
                ],
                "responses": {
        ...
        "/municipalities/search": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Texto de busca (nome do município)",
                        "name": "search",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filtro por nome da província",
                        "name": "filter",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dtos.MunicipioResultDTO"
                            }
                        }
                    },
                    "500": {
        ...
        "/municipalities/{id}": {
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID do município (UUID)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/positions/search": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Texto de busca (nome da posição)",
                        "name": "search",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dtos.PositionResultDTO"
                            }
                        }
                    },
                    "500": {
        ...
        "/provinces/{id}": {
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Erro de validação padronizado (UUID inválido, província não encontrada, etc.)",
                        "schema": {
                            "$ref": "#/definitions/utils.Payload"
                        }
                    },
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID da província (UUID)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "Payload com o campo 'nome'",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/supervisors": {
            "get": {
                "description": "Lista o histórico de supervisores por funcionário (paginação via query params)",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "summary": "Lista vínculos de supervisão de um funcionário",
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID do funcionário",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dtos.SupervisorResponseDTO"
                            }
                        }
                    },
                    "400": {
            ...
            "post": {
                "description": "Cria uma relação (SupervisorHistory) entre um funcionário e seu supervisor, com período de vigência",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Registra um vínculo de supervisão",
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.CreateSupervisorDTO"
                        }
                    }
                ],
                "responses": {
        ...
        "/supervisors/{id}": {
            "get": {
                ...
                "summary": "Busca um vínculo de supervisão pelo ID",
                "parameters": [
                    {
                        "type": "string",
            ...
            "put": {
                "description": "Atualiza supervisor e/ou período de vigência de um vínculo existente",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Atualiza um vínculo de supervisão",
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID do vínculo",
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dtos.UpdateSupervisorDTO"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                "description": "Exclui um vínculo de supervisão pelo ID",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "summary": "Remove um vínculo de supervisão",
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID do vínculo",
    ...
    "definitions": {
        ...
        "dtos.EmployeeStatusResponseDTO": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
